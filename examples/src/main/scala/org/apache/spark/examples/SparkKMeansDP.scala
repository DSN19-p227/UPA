...
object SparkKMeansDP {
  ...
  def main(args: Array[String]) {
    ...
    val data = lines.mapDP(parseVector _, args(3).toDouble).cache()
    val K = args(1).toInt
    val convergeDist = args(2).toDouble

    val kPoints = Array(Vector(1000.0,1000.0),
      Vector(2000.0,2000.0),
      Vector(3000.0,3000.0),
      Vector(4000.0,4000.0),
      Vector(5000.0,5000.0))
    var tempDist = 10000.0
...
//      newPoints.map(pp => println(pp._1))
      //********************Add noise**************************
val LocalSensitivity = System.nanoTime()//**************Time
      ...
      val LocalSensitivityelapsedTime = (System.nanoTime() - LocalSensitivity)
      println("elapsedTime: " + LocalSensitivityelapsedTime)
